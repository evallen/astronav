...
if __name__ == "__main__":
    ...
    ts = load.timescale()
    measure_time = ts.utc(2022, 10, 24, 5, 25, 51)
    ...
    betelgeuse_lat, betelgeuse_lon = zenith_to_latlon(betelgeuse_ra, betelgeuse_dec, measure_time)
    ...
    algenib_lat, algenib_lon = zenith_to_latlon(algenib_ra, algenib_dec, measure_time)
    ...
    schedar_lat, schedar_lon = zenith_to_latlon(schedar_ra, schedar_dec, measure_time)
